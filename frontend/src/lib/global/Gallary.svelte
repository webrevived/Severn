<script lang="ts">
    ...
    const resize = () => {
        ...
        if (imgCache === null || imgCache === undefined) imgCache = document.querySelectorAll('.scale-img')
...
<section 
    class="relative mt-$mt mb-30 min-h-225 gap-6.25"
    flex="~ col"
    align="items-center"
>
    <img class="w-max h-max mb-2.5" src="/images/Gallary_Circle.png" alt="">
    <h1 class="text-1 text-brown-1200">Our Gallery</h1>
    <h2 
        class="heading-1 font-normal max-w-163"
        text="20px md:37px center black-600"
    >Say hi and follow along for our gallery @savencompany</h2>
