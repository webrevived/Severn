...
{:else}
    <section class="x-container w-full pt-26 pb-101 gap-5" flex="~ col" align="items-center">
        ...
        <p class="heading-3 text-black-600">Unable to find what you have searched for. Go to the <span font="bold">Our Shop</span> for more </p>
        <p class="text-1 text-brown-1200">If not maybe double check your spelling or try something else. Our shop have great collection</p>
    </section>
{/if}