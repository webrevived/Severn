...
<div class="border-black-600 border-1 rounded-lg max-w-2xl mx-auto p-8 mb-16">
	<h2 class="text-black-600 font-semibold mb-8 text-xl">New account</h2>

	<div class="inputs flex flex-col gap-8">
		...
		<span class="font-semibold text-base flex items-center gap-3 uppercase"
			>Join newsletter <Checkbox /></span
		>
	</div>

	<div class="flex items-center justify-between my-8">
		<span class="text-base font-semibold border-b-1">Forgot your password</span>
		<Button>Register</Button>
	</div>

	<h3 class="text-base font-semibold  mx-auto block max-w-max">
